...
export function TransitionWorkspace({ onApply, notify }) {
  ...
  const transitions = [
    'Cross Dissolve', 'Fade', 'Dip to Black', 'Dip to White', 'Slide Left', 'Slide Right', 'Push',
    'Zoom In', 'Zoom Out', 'Smooth Zoom In', 'Smooth Zoom Out', 'Zoom In + Distort', 'Zoom Out + Distort',
    'Zoom In Rotate', 'Zoom Out Rotate', 'Rotate + Zoom', 'Camera Push In', 'Camera Pull Out', 'Camera Pan Left', 'Camera Pan Right',
    'Camera Tilt Up', 'Camera Tilt Down', 'Camera Shake', 'Handheld Camera', 'Whip Pan Left', 'Whip Pan Right',
    'Light Leak Warm', 'Light Leak Cool', 'Light Leak Film', 'Flash', 'Blur Transition', 'Spin Zoom',
  ]
