...
const TEXT_PRESETS = [
  ...
  { name: 'Callout', fontSize: 52, color: '#111111', background: '#ffd400', align: 'center', bold: true, italic: false, underline: false, x: 50, y: 50, animationIn: 'Pop', animationOut: 'Shrink', animationDuration: .35, duration: 3 },
]
